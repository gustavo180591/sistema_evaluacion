    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-1">
                        <i class="fas fa-user-tie text-primary"></i> Crear Nuevo Evaluador
                    </h1>
                </div>
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-primary text-white py-4">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-user-tie me-2"></i> Datos del Nuevo Evaluador
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form method="POST" class="needs-validation" novalidate id="formEvaluador">
                        ...
                        <div class="form-section mb-4">
                            ...
                            <!-- Primera fila: Nombre, Apellido y Email -->
                            <div class="form-row">
                            ...
                            <!-- Segunda fila: Contraseña y Confirmar -->
                            <div class="form-row">
                                <div class="form-field">
                                    <div class="field-card">
                                        <div class="form-group">
                                ...
                                <!-- Campo vacío para mantener distribución -->
                                <div class="form-field">
                                    <div class="field-card" style="visibility: hidden;">
                                        <div class="form-group">
                        ...
                        <div class="d-flex justify-content-center align-items-center pt-3 border-top gap-3">
                            ...
                            <button type="submit" class="btn btn-success px-4">
                                <i class="fas fa-user-plus me-1"></i> Crear Evaluador
                            </button>
                        </div>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validatePassword() {
        if (password.value !== confirmPassword.value && confirmPassword.value !== '') {
            ...
            // Si el campo está vacío, no mostrar error ni éxito
            confirmPassword.setCustomValidity('');
    ...
    inputs.forEach(input => {
        // Excluir campos de contraseña de la validación genérica
