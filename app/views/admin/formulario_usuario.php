        ...
        <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Complete la información para registrar un nuevo usuario en el sistema</p>
                </div>
                <a href="index.php?controller=Admin&action=usuarios" class="btn btn-outline-secondary">
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-primary text-white py-4">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-user-plus me-2"></i> Datos del Nuevo Usuario
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form method="POST" class="needs-validation" novalidate id="formUsuario">
                        ...
                        <div class="form-section mb-4">
                            ...
                            <!-- Segunda fila: Rol, Contraseña y Confirmar -->
                            <div class="form-row">
                                <div class="form-field">
                                    <div class="field-card">
                                        <div class="form-group">
